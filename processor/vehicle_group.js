...
var VehicleGroup = function(fleet_params, params) {
	...
	this.getMaintenanceCosts = function(){
		...
		if (this.fixed_vars.hasOwnProperty("maintenance_costs_charger")) {
			this.maintenance_costs_charger = this.fixed_vars["maintenance_costs_charger"] / this.electro_fleet_size
		}
		...
		for (var i in scenarios) {
			...
			if (this.energy_type == "benzin" || this.energy_type == "diesel") {
				...
				if (this.fixed_vars.hasOwnProperty("charging_option_cost")) {
					this.charging_option_cost = this.fixed_vars["charging_option_cost"]  / this.electro_fleet_size
				}
	...
	this.getFixedCosts = function() {
		...
		if (this.fixed_vars.hasOwnProperty("fixed_costs_car_tax")) {
			...
			fleet_params.kfzsteuer["BEV"][this.car_type] = this.fixed_vars["fixed_costs_car_tax"]
		}
